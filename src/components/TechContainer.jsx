import { DiHtml5, DiCss3, DiJsBadge, DiNodejsSmall, DiMysql, DiReact, DiMongodb, DiLinux } from 'react-icons/di'
...
const technologies = [
  ...
  { id: "linux", name: "Linux", icon: <DiLinux />,desc:"Habilidade em administração de sistemas Linux, incluindo instalação, configuração e manutenção." },
]
